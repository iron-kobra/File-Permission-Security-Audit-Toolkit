...
find ../tests/test_links -type l 2>/dev/null >> "$OUTPUT_FILE"
echo "" >> "$OUTPUT_FILE"

echo "[Broken Links]" >> "$OUTPUT_FILE"
find ../tests/test_links -xtype l 2>/dev/null >> "$OUTPUT_FILE"
echo "" >> "$OUTPUT_FILE"

BROKEN_COUNT=$(find ../tests/test_links -xtype l 2>/dev/null | wc -l)
